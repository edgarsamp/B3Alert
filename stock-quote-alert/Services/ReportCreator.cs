...
namespace stock_quote_alert.Services {
    internal class ReportCreator {
        public string GenerateMessage(StockHistory history, MonitoredStock monitoredStock) {
            ...
            var message = $"<p>The following data was obtained according to the last 20 {monitoredStock.Name} stock price checks.</p>";
            message += "<ul>";
        ...
        public string GenerateAverageGraph(StockHistory history, MonitoredStock stock) {
